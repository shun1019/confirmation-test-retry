    ...
    <div class="admin__inner">
        <form class="search-form" action="/search" method="get">
            ...
            <div class="search-form__actions">
                <input class="search-form__search-button" type="submit" value="検索">
                <input class="search-form__reset-button" type="submit" value="リセット" name="reset">
            </div>
        </form>
        ...
        <div class="export-form">
            <form action="{{'/export?'.http_build_query(request()->query())}}" method="post">
                @csrf
                <input class="export__button" type="submit" value="エクスポート">
            </form>
        ...
        <table class="admin__table">
            ...
            <tr class="admin__row">
                ...
                <td class="admin__data">
                    <a class="admin__detail-button" href="#{{ $contact->id }}">詳細</a>
                </td>
            </tr>
